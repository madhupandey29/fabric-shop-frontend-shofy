...
import {
  FaFacebookF, FaInstagram, FaYoutube, FaLinkedinIn, FaWhatsapp, FaTwitter, FaHeart, FaUser,
} from 'react-icons/fa';
              ...
              <div className="tp-mega-menu-wrapper p-relative">
                <div className="row align-items-center">
                  <div className="col-6 col-sm-4 col-md-4 col-lg-3 col-xl-2">
                    <div className="logo d-flex align-items-center" style={{ gap: 12 }}>
                      <Link href="/" className="d-flex align-items-center" style={{ gap: 12 }}>
                        <Image
                          src={logo}
                          alt="logo"
                          width={120}
                          height={40}
                          style={{ height: 'auto', width: 'auto', maxWidth: 120, maxHeight: 40 }}
                    ...
                    <div className="tp-header-bottom-right d-flex align-items-center justify-content-end">
                      ...
                      <div className="tp-header-action d-flex align-items-center">
                        <div className="tp-header-action-item d-none d-lg-block me-2">
                          <Link href="/login" className="tp-header-action-btn"><FaUser /></Link>
                        </div>
                        <div className="tp-header-action-item d-none d-lg-block me-2">
                          <Link href="/wishlist" className="tp-header-action-btn">
                            <FaHeart /><span className="tp-header-action-badge">{wishlist.length}</span>
                          </Link>
                        </div>
                        <div className="tp-header-action-item me-2">
                          <button onClick={() => dispatch(openCartMini())} className="tp-header-action-btn cartmini-open-btn">
                            <CartTwo /><span className="tp-header-action-badge">{quantity}</span>
                          </button>
                        </div>
